...
class Account extends ObjectData
{
	...
	public $data = array('name' => null, 'password' => null, 'premdays' => 0, 'coins' => 0, 'email' => null, 'key' => null, 'create_ip' => null, 'creation' => null, 'premium_points' => 0, 'page_access' => 0, 'location' => null, 'rlname' => null, 'birth_date' => null, 'gender' => null, 'email_new' => null, 'email_new_time' => 0, 'email_code' => null, 'next_email' => 0, 'last_post' => 0, 'flag' => null, 'vote' => 0, 'loyalty_points' => 0, 'guild_points' => 0, 'authtoken' => 0);
	public static $fields = array('id', 'name', 'password', 'premdays', 'coins', 'email', 'key', 'create_ip', 'creation', 'premium_points', 'page_access', 'location', 'rlname','birth_date', 'gender', 'email_new', 'email_new_time', 'email_code', 'next_email', 'last_post', 'flag', 'vote', 'loyalty_points', 'guild_points', 'authtoken');
	public $players;
	public $playerRanks;
	public $guildAccess;
	public $bans;
